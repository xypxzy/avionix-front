				...
				{items.map((element, elementId) => (
					...
					>
						<Image
							...
							alt={element.flight.to}
							width={550}
							height={350}
							className={`size-full max-h-[100px] object-cover object-center sm:max-h-[200px] md:max-h-[250px] lg:max-h-[327px]`}
						/>
						<h4 className='max-w-[180px] truncate text-[12px] sm:max-w-[300px] sm:text-xs md:max-w-[525px] md:text-base '>
							{element.description}
						</h4>
