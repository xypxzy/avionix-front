			...
			<div className={`w-full`}>
				<Tabs defaultValue='g-info' className='w-full'>
						...
						<div className={`flex gap-10`}>
							<Card className={`w-full border-[3px]`}>
								<CardHeader className={`rounded-t-sm bg-light_sky p-3`}>
									<CardTitle
										className={`text-lg font-medium text-background_hero`}
									>
										Personal details
									</CardTitle>
								</CardHeader>
								<CardContent className='flex gap-12'>
									...
									<div className={`w-full space-y-3 pt-5`}>
										...
										<div>
											...
											<div className={`flex`}>
												<Input
													className={`rounded-r-none border-r-0 focus:border-none`}
													id='name'
													value='1'
													onChange={() => null}
												/>
												...
												/>
												<Input
													className={`rounded-none border-x-0 focus:border-none`}
													id='name'
													value='Jun'
													onChange={() => null}
												/>
												...
												/>
												<Input
													className={`rounded-l-none border-l-0 focus:border-none`}
													id='name'
													value={'1990'}
													onChange={() => null}
												/>
							...
							<Card className={`max-h-[300px] w-full border-[3px]`}>
								...
								<CardFooter className={`w-full p-0 px-7`}>
									<Button
										className={`w-full border bg-transparent text-dark_blue`}
									>
										Delete account
									</Button>
								</CardFooter>
					...
					<TabsContent value='booking'>
						<div
							className={`my-60 flex flex-col items-center justify-center gap-10`}
						>
							<Plane className={`size-20`} />
							<p className={`text-xl`}>
								У вас пока нет забронированных рейсов!
							</p>
						</div>
					</TabsContent>
